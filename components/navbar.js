      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex px-4">
            ...
            <a
                className={`block text-5xl font-custom font-bold text-white rounded-l-lg px-4 ${isHomePage ? 'bg-green5' : 'bg-green4'
            ...
            <Link legacyBehavior href="/projects">
              <a className={`block text-5xl font-custom font-bold text-white rounded-r-lg px-4 ${isProjectsPage ? 'bg-green5' : 'bg-green4'
