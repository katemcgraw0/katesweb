          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/2 lg:pl-8 flex items-center ">
                <div className="bg-green3 p-4 text-white rounded-xl w-full ">
                  ...
                  <p className="sm:text-2xl text-lg mb-4 font-bodyCust">
                    Hover below to learn more about me!
                  </p>
                  <div className="flex flex-col space-y-4 font-custom text-xl">
                  <IconWithText src="/icons/coding-icon.png" alt="Coding Icon" text="I am an aspiring Software Engineer." />
                    <IconWithText src="/icons/home-icon.png" alt="Home Icon" text="I am from San Diego, CA." />
                    <IconWithText src="/icons/school-icon.png" alt="School Icon" text="I am studying CS at UMich. Go Blue!!!!" />
                    <IconWithText src="/icons/teaching-icon.png" alt="Teacher Icon" text="I am a TA for a CS Theory class, EECS 376." />
